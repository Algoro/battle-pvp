...
const S = (name: string, type: string, required = true): Rule => ({ name, type, required });

// type: "string" | "number" | "boolean" | "object" | "team"
...
export function validateMessage(msg: any): { ok: boolean; error?: string } {
