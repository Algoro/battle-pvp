...
// intercept stepFrame: set follow_HQ (0xB0) + downward direction for all live enemies,
// leaving NET_DIR=FF (ASM routes through bra_DDE4)
...
for(let f=0; f<50000; f++){
  // set follow_HQ for live enemies
