...
export interface LobbySettings { defSlots: number; attSlots: number; autoStart: boolean; requireReady: boolean; fillBots: boolean; stage: number; defStars: number; defPistol: boolean; features: string[]; featureOptions?: Record<string, Record<string, string | number | boolean>>; }
