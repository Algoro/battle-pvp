...
- **Опциональные патч-фичи** (первая — «Пистолет»: приз и 4-я звезда дают супер-оружие) — хост/соло выбирает набор, все клиенты собирают один ROM; у фич есть **настраиваемые параметры** с авто-UI и валидацией; см. `docs/optional-patches.md`.
