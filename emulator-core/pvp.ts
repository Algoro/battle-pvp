...
// src/nes.d.ts объявляет только именованный экспорт NES, тогда как рантайм-модуль
// src/nes.js отдаёт default. Берём default через namespace-объект, чтобы не менять
// рантайм-семантику импорта.
