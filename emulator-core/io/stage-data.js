...
export function readStageBytes(rom, stage) {
...
export function readStageBlocks(rom, stage) {
...
export function readBlockTiles(rom, blockId) {
  const bank = rom.rom[0];
