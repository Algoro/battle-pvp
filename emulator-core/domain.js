...
import { BTN } from "./rom-contract.js";
...
export function tankHi(flag) { return flag & 0xf0; }
export function isTankAlive(flag) { const hi = tankHi(flag); return hi >= 0x90 && hi <= 0xd0; }
export function isTankActive(flag) { const hi = tankHi(flag); return hi >= 0x80 && hi <= 0xd0; }
export function isTankSpawning(flag) { return tankHi(flag) >= TANK_RESPAWN; }
export function isTankDead(flag) { return flag === TANK_EMPTY; }
export function tankDir(flag) { return flag & 3; }
export function movingFlag(dir) { return TANK_MOVING | (dir & 3); }
export function standingFlag(dir) { return TANK_STANDING | (dir & 3); }
...
export function tankSpeed(type) {
...
export function isBrick(v) {
  return (v >= BRICK_MIN && v <= BRICK_MAX) || BRICK_EXTRA.includes(v);
}
export function isSteel(v) { return v === TILE.STEEL || v === TILE.STEEL_ALT; }
export function isWater(v) { return v === TILE.WATER; }
export function isIce(v) { return v === TILE.ICE; }
export function isTree(v) { return v === TILE.TREE; }
export function isEagleTile(v) { return v >= TILE.EAGLE_MIN && v <= TILE.EAGLE_MAX; }
...
export function isRoad(v) { return v >= 0x20 && v < 0x80 && v !== TILE.ICE && v !== TILE.TREE; }
...
export function isBulletFlying(s) { return (s & 0xf0) === BULLET.FLYING; }
export function bulletDir(s) { return s & 3; }
export function flyingBullet(dir) { return BULLET.FLYING | (dir & 3); }
...
export function upgradeToStars(u) {
