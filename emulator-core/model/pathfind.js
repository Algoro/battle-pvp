...
import { FIELD, DX, DY, inBounds, cellIdx, tankPassable, isBrick, tileCost, brickHealth } from "./game-view.js";
...
export function bfsDirection(field, from, to) {
...
export function costField(field, goal, brickCost = (v) => Math.max(1, brickHealth(v))) {
...
function defaultCost(field, c, r, allowBreak) {
...
export function pathDirection(field, from, to, opts = {}) {
...
export function isReachable(field, from, to, opts = {}) {
